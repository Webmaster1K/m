  ...
  return (
    <div className='Cart'>
      ...
      <div className='SideBlockOrder' style={styleSideBlockOrder}>
        <img src='./img/RemoveCart.jpg' width={32} height={32} className='ms-auto' style={{margin: '30px', position: 'absolute', top: '0', right: '0'}} onClick={()=> SetOpenCart(false)}/>
        ...
        <h5 style={{color: '#999999'}}>Ваш заказ #18 скоро будет передан курьерской доставке</h5>
          <img src='/img/backButton.png' width={325} height={55}/>
      </div>
      <div className='SideBlock' style={styleSideBlock}>
        <Stack direction="horizontal" gap={3}>
          <h2>Корзина</h2>
          <img src='./img/RemoveCart.jpg' width={32} height={32} className='ms-auto' style={{marginRight: '30px'}} onClick={()=> SetOpenCart(false)}/>
        </Stack>
        <CartOne/>
