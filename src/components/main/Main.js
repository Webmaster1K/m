...
function Main() {
  let watch = [
      ...
      {id: 3, name: 'Часы жен бронницкий ЮВЕЛИР', cont: '7 795', img: '/img/watch3.png'},
      ...
      {id: 7, name: 'Часы жен бронницкий ЮВЕЛИР', cont: '7 795', img: '/img/watch3.png'},
      ...
      {id: 11, name: 'Часы жен бронницкий ЮВЕЛИР', cont: '7 795', img: '/img/watch3.png'},
